                        ...
                        <div class="card-body">
                            <form action="{{route('home_banner.manage_home_banner_process')}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <label for="category_name" class="control-label mb-1">Text One</label>
                                            <input id="text" value="{{$text}}" name="text" type="text" class="form-control" aria-required="true" aria-invalid="false">
                                        </div>
                                        <div class="col-md-6">
                                            <label for="texttwo" class="control-label mb-1">Text Two</label>
                                            <input id="texttwo" value="{{$texttwo}}" name="texttwo" type="text" class="form-control" aria-required="true" aria-invalid="false">
                                        </div>
                                        <div class="col-md-6">
                                            <label for="category_name" class="control-label mb-1">Text Three</label>
                                            <input id="textthree" value="{{$textthree}}" name="textthree" type="text" class="form-control" aria-required="true" aria-invalid="false">
                                        </div>
                                        <div class="col-md-6">
