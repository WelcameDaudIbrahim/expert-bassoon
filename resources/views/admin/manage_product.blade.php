...
<script src="{{
   asset('admin_assets/ckeditor/ckeditor.js')
}}"></script>
               ...
               <div class="card">
                  <div class="card-body">
                     ...
                     <div class="form-group">
                        ...
                        @enderror
                        @if($image!='')
                           <a href="{{asset(stor().$image)}}" target="_blank"><img width="100px" src="{{asset(stor().$image)}}"/></a>
                        @endif
                     </div>
                     <div class="form-group">
                        <div class="row">
                  ...
                  <div class="card-body">
                     <div class="form-group">
                        ...
                        <div class="col-md-4 product_images_{{$loop_count_num++}}"  >
                              ...
                              @if($pIArr['images']!='')
                                 <a href="{{asset(stor().$pIArr['images'])}}" target="_blank"><img width="100px" src="{{asset(stor().$pIArr['images'])}}"/></a>
                              @endif
                           </div>
                           ...
                           <div class="col-md-2">
                              ...
                              @if($loop_count_num==2)
                                <button style="margin:30px 0 0 0;" type="button" class="btn btn-success btn-lg" onclick="add_image_more()">
                     ...
                     <div class="form-group">
                        <div class="row">
                           ...
                           <div class="col-md-4">
                              ...
                              @if($pAArr['attr_image']!='')
                                 <img width="100px" src="{{asset(stor().$pAArr['attr_image'])}}" {{$image_required}}/>
                              @endif
                           </div>
                           <div class="col-md-2">
                              ...
                              @if($loop_count_num==2)
                                <button style="margin:30px 0 0 0;" type="button" class="btn btn-success btn-lg" onclick="add_more()">
                                <i class="fa fa-plus"></i>&nbsp; Add</button>
                              @else
