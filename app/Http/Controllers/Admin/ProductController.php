...
class ProductController extends Controller
{
    ...
    public function manage_product(Request $request,$id='')
    {
        if($id>0){
            ...
            $result['category_id']=old('category_id');
            $result['name']=old('name');
            $result['slug']=old('slug');
            $result['image']=old('image');
            $result['brand']=old('brand');
            $result['short_desc']=old('short_desc');
            $result['desc']=old('desc');
            $result['keywords']=old('keywords');
            $result['is_promo']=old('is_promo');
            $result['is_featured']=old('is_featured');
            $result['is_discounted']=old('is_discounted');
            $result['is_tranding']=old('is_tranding');
